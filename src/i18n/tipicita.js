...
export const sharedStages = [
  // 1993 e 2011: gli slideshow di foto lasciano il posto ai montaggi
  // d'archivio (10/08). I master sono PAL 4:3 ma arrivano già incorniciati
  // in 854×480 con bande del colore del monitor: il CSS non si tocca.
  { y: '1993', c: '380', px: 855.5, py: 180.8, key: true,
    video: '/tipicita/tracce/1993.mp4', poster: '/tipicita/tracce/1993-poster.jpg' },
  ...
  { y: '2011', c: '380', px: 855.5, py: 180.8, key: true,
    video: '/tipicita/tracce/2011.mp4', poster: '/tipicita/tracce/2011-poster.jpg' },
  ...
  // le quattro missioni che erano senza immagini (media installati il 10/08)
  { y: '2022', tag: 'AE', c: '784', px: 1038.5, py: 273.6,
    photos: ['/tipicita/tracce/2022ae-1.jpg','/tipicita/tracce/2022ae-2.jpg','/tipicita/tracce/2022ae-3.jpg','/tipicita/tracce/2022ae-4.jpg'] },
  { y: '2022', tag: 'TZ', c: '834', px: 974.4, py: 438.6,
    photos: ['/tipicita/tracce/2022tz-1.jpg','/tipicita/tracce/2022tz-2.jpg','/tipicita/tracce/2022tz-3.jpg','/tipicita/tracce/2022tz-4.jpg'] },
  { y: '2023', tag: 'UK', c: '826', px: 799.5, py: 138.8,
    photos: ['/tipicita/tracce/2023uk-1.jpg','/tipicita/tracce/2023uk-2.jpg','/tipicita/tracce/2023uk-3.jpg','/tipicita/tracce/2023uk-4.jpg'] },
  { y: '2023', tag: 'FR', c: '250', px: 809.2, py: 152.0,
    photos: ['/tipicita/tracce/2023fr-1.jpg','/tipicita/tracce/2023fr-2.jpg','/tipicita/tracce/2023fr-3.jpg'] },
...
export const content = {
  ...
  it: {
    ...
    stages: [
      { t: 'Festival dei prodotti tipici delle Marche', p: 'Fermo', caption: 'Fermo, 1993 — dall’archivio video della prima edizione.',
      ...
      { t: 'Isole Lofoten', p: 'Norvegia', caption: 'Isole Lofoten — dal video della missione.',
      ...
      { t: 'Made in Marche Festival', p: 'Fermo', caption: 'Fermo, 2011 — dal video del Made in Marche Festival.',
        d: 'Il tipico smette di essere soltanto cibo. Con la Made in Marche Gallery entrano la manualità — dall’artigianato tradizionale al design contemporaneo — e i territori con i loro progetti e i loro eventi: tutti gli attrattori in una sola esperienza, per un racconto a tre dimensioni.' },
      ...
      { t: 'Taste Marche Experience', p: 'New York, USA', caption: 'New York — Taste Marche Experience da Lucciola.',
      ...
      { t: 'III Settimana della Cucina Italiana nel Mondo', p: 'Tirana e Valona, Albania', caption: 'Tirana — la Settimana della Cucina Italiana.',
      ...
      { t: 'Semplicemente “Festival”', p: 'Fermo', caption: 'Semplicemente “Festival” — il motion poster.',
        d: 'Dopo il Covid il racconto si allarga: non più soltanto le esperienze del made in Marche, ma una rassegna di tutto ciò che oggi rappresenta la tipicità italiana. Il nome si accorcia di conseguenza — Tipicità diventa semplicemente “Festival”, ecosistema delle micro-Italie autentiche.' },
      { t: 'EXPO2020 Dubai', p: 'Dubai, EAU', caption: 'EXPO2020 Dubai — dalla missione negli Emirati.',
        d: 'Tipicità dà forma all’immateriale: l’esperienza di viaggio si traduce in un cofanetto di profumi, sapori e suggestioni digitali, per raccontare un territorio in evoluzione.' },
      { t: 'VII Settimana della Cucina Italiana nel Mondo', p: 'Dar Es Salaam e Zanzibar, Tanzania', caption: 'Dar es Salaam e Zanzibar — dalla missione in Tanzania.',
        d: 'A Dar es Salaam e Zanzibar, prima volta in Africa, Tipicità rappresenta l’Italia intera.' },
      { t: 'Tipicità Experience', p: 'Londra, Regno Unito', caption: 'Hampstead, Londra — da Rossodisera.',
      ...
      { t: 'VIII Settimana della Cucina Italiana nel Mondo', p: 'Parigi', caption: 'Parigi — la presentazione della candidatura Unesco.',
      ...
      { t: 'IX Settimana della Cucina Italiana nel Mondo', p: 'Tokyo e Osaka', caption: 'Tokyo e Osaka — la IX Settimana.',
        d: 'Una master class sul brodetto per gli chef giapponesi, l’accordo fra gli atenei di Ritsumeikan e Camerino sulla food science e, a Osaka, l’esperienza di Kumiko Muraji all’Osteria La Cicerchia.' },
      { t: 'Taste Marche Experience a EXPO2025', p: 'Osaka, Kyoto, Tokyo', caption: 'EXPO2025 Osaka, Padiglione Italia — dalla missione giapponese.',
        d: 'Una settimana marchigiana al Padiglione Italia dell’Expo universale, poi Kyoto e Tokyo: le tre F — moda, cibo, arredo — e una masterclass alla Ritsumeikan su oliva ascolana e maccheroncini di Campofilone. L’incontro di Osaka si intitola «Diplomazia culturale».' },
      { t: 'X Settimana della Cucina Italiana nel Mondo', p: 'Bahia Blanca, Buenos Aires, Ushuaia', caption: 'Dalla rotta argentina.',
  ...
  en: {
    ...
    stages: [
      { t: 'Festival of Typical Products of the Marche', p: 'Fermo', caption: `Fermo, 1993 — from the first edition's film archive.`,
      ...
      { t: 'Lofoten Islands', p: 'Norway', caption: `Lofoten Islands — from the mission footage.`,
      ...
      { t: 'Made in Marche Festival', p: 'Fermo', caption: `Fermo, 2011 — from the Made in Marche Festival footage.`,
        d: `Typicity stops being only food. With the Made in Marche Gallery come craft — from traditional workshops to contemporary design — and territories with their projects and events: every attractor in one experience, for a three-dimensional account.` },
      ...
      { t: 'Taste Marche Experience', p: 'New York, USA', caption: `New York — Taste Marche Experience at Lucciola.`,
      ...
      { t: '3rd Week of Italian Cuisine in the World', p: 'Tirana & Vlorë, Albania', caption: `Tirana — the Week of Italian Cuisine.`,
      ...
      { t: 'Simply "Festival"', p: 'Fermo', caption: `Simply "Festival" — the motion poster.`,
        d: `After Covid the story widens: no longer only made-in-Marche experiences, but a survey of everything that stands for Italian typicity today. The name shortens accordingly — Tipicità becomes simply "Festival", an ecosystem of Italy's most authentic micro-communities.` },
      { t: 'EXPO2020 Dubai', p: 'Dubai, UAE', caption: `EXPO2020 Dubai — from the Emirates mission.`,
        d: `Tipicità gives shape to the intangible: the travel experience becomes a case of scents, flavours and digital cues, telling the story of a territory in transformation.` },
      { t: '7th Week of Italian Cuisine in the World', p: 'Dar es Salaam & Zanzibar, Tanzania', caption: `Dar es Salaam and Zanzibar — from the Tanzania mission.`,
        d: `In Dar es Salaam and Zanzibar — a first in Africa — Tipicità represents Italy itself.` },
      { t: 'Tipicità Experience', p: 'London, United Kingdom', caption: `Hampstead, London — at Rossodisera.`,
      ...
      { t: '8th Week of Italian Cuisine in the World', p: 'Paris', caption: `Paris — presenting the UNESCO candidacy.`,
      ...
      { t: '9th Week of Italian Cuisine in the World', p: 'Tokyo & Osaka', caption: `Tokyo & Osaka — the 9th Week.`,
        d: `A masterclass on brodetto for Japanese chefs, the agreement between the universities of Ritsumeikan and Camerino on food science and, in Osaka, Kumiko Muraji's Osteria La Cicerchia.` },
      { t: 'Taste Marche Experience at EXPO2025', p: 'Osaka, Kyoto, Tokyo', caption: `EXPO2025 Osaka, Italy Pavilion — from the Japanese mission.`,
        d: `A Marche week at the Italy Pavilion of the World Expo, then Kyoto and Tokyo: the three Fs — fashion, food, furniture — and a masterclass at Ritsumeikan on Ascoli olives and Campofilone maccheroncini. The Osaka panel is titled "Cultural Diplomacy".` },
      { t: '10th Week of Italian Cuisine in the World', p: 'Bahía Blanca, Buenos Aires, Ushuaia', caption: `From the Argentine route.`,
