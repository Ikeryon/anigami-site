...
export const sharedStages = [
  ...
  { y: '2022', c: '834', px: 974.4, py: 438.6, key: true, video: '/tipicita/tracce/2022-festival.mp4' },
  ...
  { y: '2025', c: '032', px: 555.2, py: 582.4,
  ...
  { y: '2027', c: '380', px: 855.5, py: 180.8, key: true },
];
...
export const content = {
  ...
  it: {
    ...
    stages: [
      ...
      { t: 'Semplicemente “Festival”', p: 'EXPO2020 Dubai · Dar Es Salaam e Zanzibar', caption: 'Semplicemente “Festival” — il motion poster. [BOZZA]',
      ...
      { t: 'X Settimana della Cucina Italiana nel Mondo', p: 'EXPO2025 Osaka · Bahia Blanca, Buenos Aires, Ushuaia', caption: 'Da Osaka alla fine del mondo — e ritorno a Fermo. [BOZZA]',
      ...
      { t: '35ª edizione', p: 'Fermo, 12–14 marzo',
  ...
  en: {
    ...
    stages: [
      ...
      { t: 'Simply "Festival"', p: 'EXPO2020 Dubai · Dar es Salaam & Zanzibar', caption: `Simply "Festival" — the motion poster. [DRAFT]`,
        d: `Tipicità becomes simply "Festival", an ecosystem of Italy's most authentic micro-communities. At EXPO Dubai its leaf turns into a phygital gift box, a QR code transforming products into journeys. And in Dar es Salaam and Zanzibar — a first in Africa — Tipicità represents Italy itself.` },
      ...
      { t: '10th Week of Italian Cuisine in the World', p: 'EXPO2025 Osaka · Bahía Blanca, Buenos Aires, Ushuaia', caption: `From Osaka to the end of the world — and back to Fermo. [DRAFT]`,
        d: `From EXPO Osaka to the longest route yet: three thousand kilometres through Bahía Blanca — Fermo's twin city — Buenos Aires and Ushuaia, bringing Mediterranean biodiversity to the world's southernmost city on the eve of the UNESCO verdict. A year later, Argentina sets up its own stall in Fermo.` },
      { t: '35th edition', p: 'Fermo, 12–14 March',
        d: `The route comes home: Fermo, 12–14 March 2027. Not to stop — to set out again.` },
    ],
  },
};
